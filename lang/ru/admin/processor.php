...
$MESS["mailtemplate"] = "Почтовые шаблоны (неактивные)";
$MESS["upload"] = "Очистка папки upload";
$MESS["iblock"] = "Очистка папки upload (iblock)";
$MESS["props"] = "Очистка папки upload (props)";
$MESS["user"] = "Удаление неактивных пользователей";
$MESS["orderstat"] = "Статистика по заказам";
$MESS["cache"] = "Очистить кэш";
$MESS["attackevent"] = "Очистить журнал вторжений";
$MESS["webhist"] = "Очистить историю веб-статистики";
$MESS["dropbasket"] = "Неоформленные корзины";
$MESS["unconfirmed"] = "Несуществующие адреса подписчиков";
$MESS["stathistory"] = "История почтовых событий";
$MESS["webform"] = "Очистка результатов веб-форм";
$MESS["lang"] = "Языковые файлы";
$MESS["module"] = "Модули (в статусе удален)";
$MESS["component"] = "Компоненты";
$MESS["rubric"] = "Выпуски рассылки за выбранный период";
$MESS["perfmon"] = "Статистика монитора производительности";
$MESS["saleviewed"] = "Последние просмотренные товары";

$MESS["site_analize"] = "Неактивные сайты";
$MESS["templates_analize"] = "Неиспользуемые шаблоны сайтов";
$MESS["ibelement_analize"] = "Неактивных элементов инфоблоков";
$MESS["mailtemplate_analize"] = "Почтовые шаблоны (неактивные)";
$MESS["upload_analize"] = "Анализ папки upload";
$MESS["iblock_analize"] = "Анализ папки upload (iblock)";
$MESS["props_analize"] = "Анализ папки upload (props)";
$MESS["section_analize"] = "Анализ папки upload (section)";
$MESS["user_analize"] = "Неактивные пользователи";
$MESS["orderstat_analize"] = "Статистика по заказам";
$MESS["cache_analize"] = "Кэш";
$MESS["attackevent_analize"] = "Журнал вторжений";
$MESS["webhist_analize"] = "История веб-статистики";
$MESS["dropbasket_analize"] = "Неоформленные корзины";
$MESS["unconfirmed_analize"] = "Несуществующие адреса подписчиков";
$MESS["stathistory_analize"] = "История почтовых событий";
$MESS["webform_analize"] = "Результаты веб-форм";
$MESS["lang_analize"] = "Языковые файлы";
$MESS["module_analize"] = "Модули (в статусе удален)";
$MESS["component_analize"] = "Компоненты";
$MESS["rubric_analize"] = "Выпуски рассылки за выбранный период";
$MESS["perfmon_analize"] = "Статистика монитора производительности";
$MESS["saleviewed_analize"] = "Последние просмотренные товары";

$MESS['progress'] = '<div class="adm-info-message-wrap adm-info-message-gray">
	<div class="adm-info-message">
		<span><b>#NAME#</b></span><br>
        <div class="adm-progress-bar-outer" style="width: 500px;">
            <div class="adm-progress-bar-inner" style="width: #PERSENT_VALUE#px;">
                <div class="adm-progress-bar-inner-text" style="width: 500px;">#PERSENT#%</div>
            </div>#PERSENT#%
        </div>
