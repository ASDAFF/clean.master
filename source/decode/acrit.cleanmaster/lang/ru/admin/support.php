<?
$MESS["ACRIT_CLEANMASTER_SUPPORT_TAB_NAME"] = "Техподдержка";
$MESS["ACRIT_CLEANMASTER_SUPPORT_TAB_TITLE"] = "Справочные материалы и техподдержка";
$MESS["ACRIT_CLEANMASTER_FAQ_BASE"] = "FAQ: материалы";
$MESS["ACRIT_CLEANMASTER_INSTRUCTION_BASE"] = "Общая инструкция по работе с модулем";
...
$MESS["ACRIT_CLEANMASTER_SET_BITRIX_CLOUD_MONITORING_BUTTON_ON"] = "Включить мониторинг работы модуля";
$MESS["ACRIT_CLEANMASTER_SET_BITRIX_CLOUD_MONITORING_BUTTON_OFF"] = "Отключить мониторинг работы модуля";
...
$MESS["ACRIT_CLEANMASTER_SET_BITRIX_CLOUD_MONITORING_BUTTON_OFF"] = "Отключить мониторинг работы модуля";
$MESS["ACRIT_CLEANMASTER_SET_BITRIX_CLOUD_MONITORING_BUTTON_ON"] = "Включить мониторинг работы модуля";
$MESS["ACRIT_CLEANMASTER_RECOMMENDS"] = "
